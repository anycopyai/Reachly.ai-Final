...
const CreditOption = ({ amount, cost, onPurchase }) => (
  <div className="flex-1 max-w-xs bg-white border-2 border-blue-600 rounded-xl shadow-xl overflow-hidden hover:scale-105 transition-transform duration-300">
    <div className="px-4 py-6 sm:p-6 sm:pb-4">
      ...
      <div className="mt-3 flex justify-center text-4xl leading-none font-extrabold text-gray-900">
        {cost}
      </div>
    </div>
    <div className="px-4 pt-4 pb-6 sm:px-6 sm:pt-4 sm:pb-6">
      <button
        onClick={onPurchase}
