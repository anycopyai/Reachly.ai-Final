...
const SkeltonCard = ({ }) => {
    return (
        Array(3).fill(0).map(item =>
            <div role="status" className="animate-pulse mt-16">
                <div className="w-20 h-6 bg-gray-200 rounded-full dark:bg-gray-700 me-3"></div>
                <div className="h-6 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[640px] mb-2.5 mx-auto"></div>
                <div className="h-6 mx-auto bg-gray-300 rounded-full dark:bg-gray-700 max-w-[640px]"></div>
