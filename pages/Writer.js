        ...
        <div className="bg-white sticky top-0 pt-4 md:pt-0 z-10">
          ...
          <div className="flex flex-grow items-center gap-5 mt-3 md:mt-0">
            ...
            <div className="hidden md:flex flex-row items-center ml-auto gap-2">
              ...
              <button className="text-sm text-black border-1 border-gray-300 bg-white-100 p-3 md:border-blue-700 md:bg-blue-700 md:text-white  flex-row hidden items-center gap-2">
        ...
        <div className="flex md:mt-10">
          <div className="grid grid-cols-12 min-w-full">
            ...
            >
              ...
              <form method="POST" className="w-full md:w-11/12 mt-10">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="block mb-2 text-sm text-slate-300 border border-gray-300 w-full h-12 placeholder:text-slate-300"
                ...
                <div className="mb-2">
                  ...
                  <select
                    id="tone"
                    className="border border-gray-300 text-slate-300 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <button
                  type="button"
                  className="text-gray bg-gray-100 hover:bg-blue-700 hover:text-white  focus:outline-none font-medium text-sm sm:w-auto px-5 py-2.5 text-center mb-2 float-right"
            ...
            <div
              ...
              id="results"
            >
              <h1 className="text-sm text-navblue font-medium border-b-2 border-navblue hidden ml-4 md:inline-block">
                Results
              </h1>
              ...
              {!isgenerate ? (
                ...
                <div className="result mt-10">
                  ...
                  <div className="grid bg-white md:m-4">
                    <p className="text-sm text-black-700 p-4 border-1 border-white shadow hover:border-blue-500">
                      In the age of interconnectedness, T-shirts paying homage
                      to niche interests and pop culture references have
                      experienced a meteoric rise in popularity. Whether adorned
                      with iconic movie quotes, references to beloved TV shows,
                      or symbols from video games, these T-shirts serve as a
                      wearable canvas for enthusiasts to showcase their
                      passions. The allure lies in the sense of community
                      fostered by these designs, creating a connection among
                      individuals who share common interests. As social media
                      continues to play a pivotal role in shaping pop culture,
                      T-shirts that tap into these phenomena have become not
                      just fashion statements but cultural badges proudly worn
                      by the masses.
                    </p>
                  </div>
                  ...
                  <div className="grid bg-white md:m-4">
                    <p className="text-sm text-black-700 p-4 border-1 border-white shadow hover:border-blue-500">
                      ...
                      revolution in T-shirt design. Clean lines, subtle details,
                      and carefully curated visuals come together to form
                      designs that are both sophisticated and visually striking.
                      Abstract art, geometric patterns, and artistic symbolism
                      take center stage, appealing to those with a penchant for
                      understated elegance. As consumers increasingly gravitate
                      towards simplicity and timeless aesthetics, T-shirts
                      featuring artistic minimalism have secured their spot as a
                      top choice for those who appreciate the marriage of art
                      and fashion.
                    </p>
                  </div>
                  ...
                  <div className="grid bg-white md:m-4">
                    <p className="text-sm text-black-700 p-4 border-1 border-white shadow hover:border-blue-500">
                      In the realm of T-shirt designs, dynamic typography reigns
                      supreme. From empowering quotes to witty expressions,
                      T-shirts adorned with captivating text have become the
                      go-to choice for those seeking garments that make a
                      statement. Bold fonts, creative lettering, and
                      ...
                      typography creates a symbiotic relationship that resonates
                      with a diverse audience, making dynamic typography
                      T-shirts a hot commodity in the fashion sphere.
                    </p>
                  </div>

                  <div className="flex flex-row m-4 gap-5 justify-between md:float-right">
                    <button
                      className="text-black border-2 bg-white-100 hover:bg-gray-100 focus:outline-none font-medium text-sm px-5 py-2.5 text-center"
                      onClick={() => setGenerate(false)}
                    >
                      Rewrite Intro
                    </button>
                    <button
                      className="text-gray bg-gray-100 hover:bg-blue-700 hover:text-white focus:outline-none font-medium text-sm px-5 py-2.5 text-center"
