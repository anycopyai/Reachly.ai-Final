          ...
          <div className="grid grid-cols-12 min-w-full">
            <div className="col-span-5 overflow-y-scroll scrollbar-thin">
              ...
              <form className="max-w-[550px] mt-10">
                ...
                <div className='mb-2'>
                  <label className='block mb-2 text-xs font-medium text-gray-900 dark:text-white'>Tone</label>
                ...
                <button type="submit" className="text-gray bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-xs w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-2">Skip Intro</button>

                <button type="submit" className="text-gray bg-gray-100 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-xs w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-2 float-right">Generate Intro</button>
              </form>
            </div>
