...
const Upgrade = () => {
  ...
  return (
    <div className="flex flex-col h-fit ml-0 md:ml-20">
      ...
      <div className="grid md:grid-cols-3 md:w-4/6 mx-auto gap-4 md:gap-0 mt-10 mb-10 md:border md:border-[#00000040]">
        {priceCard?.map((item, index) => {
          return (
            <div
              className="border md:border-0 md:border-r-1 md:last:border-none border-[rgba(0,0,0,0.25)] py-6 px-10 pb-12 flex flex-col gap-4"
              key={index}
            >
              <div>
